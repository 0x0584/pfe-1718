...
//		frame.setBounds(100, 100, 733, 1092);
		...
		lblRoyaumeDuMaroc.setFont(new Font("Arial", Font.PLAIN, 15));
		...
		lblLeDoyenDe.setBounds(110, 200, 485, 33);
		...
		lblAttesteQueMr.setBounds(70, 214, 525, 36);
		...
		lblNomCompletes.setBounds(110, 418, 431, 29);
		...
		label_5.setBounds(110, 439, 431, 33);
		...
		lblElJadidaLe.setBounds(270, 644, 193, 48);
		frame.getContentPane( ).add(lblElJadidaLe);

		JLabel lbls = new JLabel(" la period sus-indique");
		lbls.setFont(new Font("Arial", Font.PLAIN, 16));
		lbls.setBounds(70, 552, 566, 29);
		...
		lblLinteresseeEstTenue.setFont(new Font("Arial", Font.PLAIN, 16));
		lblLinteresseeEstTenue.setBounds(70, 583, 566, 33);
		frame.getContentPane( ).add(lblLinteresseeEstTenue);

		JLabel lblSonTravailA = new JLabel(
			"son travail a l'experation de son conge");
		lblSonTravailA.setFont(new Font("Arial", Font.PLAIN, 16));
		lblSonTravailA.setBounds(70, 604, 356, 33);
		...
		lblVueLrDahir.setBounds(110, 244, 485, 36);
		...
		lblPortantStautGeneral.setBounds(70, 288, 525, 36);
		...
		lblVueLrDahir_1.setFont(new Font("Arial", Font.PLAIN, 16));
		lblVueLrDahir_1.setBounds(110, 266, 485, 36);
		frame.getContentPane( ).add(lblVueLrDahir_1);

		JLabel lblArticle = new JLabel("Article 2");
		lblArticle.setFont(new Font("Arial", Font.PLAIN, 22));
		lblArticle.setBounds(70, 535, 158, 15);
		...
		lblUnCongeAdministratif.setFont(new Font("Arial", Font.PLAIN, 16));
		lblUnCongeAdministratif.setBounds(155, 357, 566, 33);
		...
		lblAuTitreDe.setFont(new Font("Arial", Font.PLAIN, 16));
		lblAuTitreDe.setBounds(70, 380, 566, 33);
