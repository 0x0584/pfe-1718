...
public class AttTravailView {
	...
	private void initialize(Employee e, boolean isprof) {
		...
		// frame.setBounds(100, 100, 733, 1020);
		frame.setBounds(100, 100, 733, 665);
		...
		JLabel label_5 = new JLabel(
			String.format("Nationalite: %s", e.isMoroccan( )));
		...
		lblElJadidaLe.setBounds(264, 556, 181, 48);
		frame.getContentPane( ).add(lblElJadidaLe);
		JLabel label_10 = new JLabel(String.format(
			"depuis le %s", DateUtil.parseDate(e.getHiringDate( ))));
		...
		lblAttestationDeTravail.setFont(new Font("Arial", Font.PLAIN, 21));
		...
		lblAuDepartements.setFont(new Font("Arial", Font.PLAIN, 16));
