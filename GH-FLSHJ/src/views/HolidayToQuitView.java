...
public class HolidayToQuitView {
	...
	private void initialize(Employee e, boolean isprof, String raison,
		...
		frame.setBounds(100, 100, 733, 743);
		...
		lblLeDoyenDe.setBounds(110, 201, 485, 33);
		...
		lblAttesteQueMr.setBounds(70, 221, 525, 36);
		...
		lblNomCompletes.setBounds(110, 399, 431, 29);
		...
		lblExerceSeFonctions.setBounds(110, 521, 513, 39);
		...
		lblElJadidaLe.setBounds(268, 652, 193, 48);
		...
		lblLinteresseeEstTenue.setBounds(70, 590, 566, 33);
		...
		lblSonTravailA.setBounds(70, 613, 356, 33);
		...
		lblAttestationDeTravail.setFont(
			new Font("Arial", Font.PLAIN | Font.ITALIC, 19));
		lblAttestationDeTravail.setBounds(148, 161, 437, 15);
		...
		lblPortantStautGeneral.setBounds(70, 265, 525, 36);
