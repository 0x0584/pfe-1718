...
public class HolidayExcepView {
	...
	private void initialize(Employee e, boolean isprof, String raison,
		...
		lblRoyaumeDuMaroc.setFont(new Font("Arial", Font.BOLD, 16));
		...
		label_2.setBounds(555, 65, 154, 15);
